...
@session_start();
    $this->config = array_merge(
      array(
        ...
        'consumer_key'    => 'eOL3RjJT2841pF0ANeP7bg',
        'consumer_secret' => 'xUOlUevnASU1W4c48EwO0gdUtz9LMmNYS3KGVdZZIE',
        'token'           => isset($_SESSION['oauth']['oauth_token'])?$_SESSION['access_token']['oauth_token']:'',
        'secret'          => isset($_SESSION['oauth']['oauth_token_secret'])?$_SESSION['access_token']['oauth_token_secret']:'',
        'bearer'          => '',
